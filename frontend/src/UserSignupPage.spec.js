...
describe('UserSignupPage', () => {
    ...
    describe('Interactions', () => {
        ...
        const setupForSubmit = props => {
            ...
            fireEvent.change(displayNameInput, changeEvent('Saad Guessous'));
            fireEvent.change(usernameInput, changeEvent('sguessou'));
            fireEvent.change(passwordInput, changeEvent('Return0'));
            fireEvent.change(passwordRepeat, changeEvent('Return0'));
        ...
        it('sets the passwordRepeat value into state', () => {
            ...
            fireEvent.change(
                passwordRepeatInput,
                changeEvent('my-passwordRepeat')
            );
            expect(passwordRepeatInput).toHaveValue('my-passwordRepeat');
        });
        ...
        it('calls post with user body when the fields are valid', () => {
            ...
            const expectedUserObject = {
                username: 'sguessou',
                displayName: 'Saad Guessous',
                password: 'Return0',
                passwordRepeat: 'Return0',
        ...
        it('hides spinner when there is an ongoing api call', async () => {
            const actions = {
                postSignup: mockAsyncDelayed(),
            };
            const { queryByText } = setupForSubmit({ actions });
