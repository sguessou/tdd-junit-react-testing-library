...
public class UserControllerTest {
    ...
    private User createUser() {
        User user = new User();
        user.setUsername("sguessou");
        user.setDisplayName("Saad");
        user.setPassword("P3ssword");
        return user;
    }
    ...
    @Test
    public void postUser_whenUserHasPasswordNameExceedsTheLengthLimit_receiveBadRequest() {
        User user = createUser();
        String valueOf256Chars = IntStream.rangeClosed(1, 256).mapToObj(x -> "a").collect(Collectors.joining());
        user.setPassword(valueOf256Chars + "P4");
        ResponseEntity<Object> response = postSignup(user, Object.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.BAD_REQUEST);
    }
    ...
    @Test
    public void postUser_whenUserHasPasswordAllNumbers_receiveBadRequest() {
        User user = createUser();
    ...
    @Test
    public void postUser_whenUserHasInvalidPasswordPattern_receiveGenericMessageOfPasswordPatternError() {
        User user = createUser();
        user.setPassword("alllowercase");
        ResponseEntity<ApiError> response = postSignup(user, ApiError.class);
        Map<String, String> validationErrors = response.getBody().getValidationErrors();
